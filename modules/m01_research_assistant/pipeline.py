...
class ResearchState(TypedDict):
    ...
    title: str              # generated by Writer A — clean professional title
    draft: str              # filled by Writer A (or swapped to B if B wins the debate)
    draft_b: str            # filled by Writer B
    ...
    debate_result: dict     # filled by Debate Judge
    fact_check_result: dict # filled by Fact Checker
